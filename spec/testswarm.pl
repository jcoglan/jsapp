...
my $RCS_URL = "git://github.com/jcoglan/jsapp.git";

# The directory in which the checkouts will occur.

my $BASE_DIR = "/home/jcoglan/www/tmp.jcoglan.com/app/changeset/$USER";
...
my $BUILD = "git submodule init && git submodule update && cd vendor/js.class && jake";
